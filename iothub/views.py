...
from device.models import Device,CtrlChannel,Measurement,MetricData
...
from rest_framework.decorators import action  #list_route已经弃用，被action替代
...
init_subscribe()  #注释此句,migrate如有django.db.utils.ProgrammingError: (1146, "Table 'iotplus.iothub_iotsubdev' doesn't exist")